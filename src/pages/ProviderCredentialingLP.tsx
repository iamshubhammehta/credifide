...
const SERVICES_LIST = [
  {
    ...
    desc: 'Detailed validation of all professional credentials through direct primary sources to ensure complete compliance.',
    icon: ShieldCheck,
    id: 'credentialing-1'
  },
  {
    title: 'Payer Credentialing',
    desc: 'End-to-end management of credentialing applications across all major commercial and government health plans.',
    icon: UserPlus,
    id: 'credentialing-2'
  },
  {
    title: 'CAQH Profile Management',
    desc: 'Complete setup, regular maintenance, and timely attestations of your CAQH ProView profiles.',
    icon: Database,
    id: 'credentialing-3'
  },
  {
    title: 'Initial Provider Credentialing',
    desc: 'Expert steering through the complex initial credentialing process for new practices or providers.',
    icon: Award,
    id: 'credentialing-4'
  },
  {
    title: 'Recredentialing Management',
    desc: 'Proactive oversight and handling of regular payer recredentialing to prevent lapsing and revenue gaps.',
    icon: RefreshCw,
    id: 'credentialing-5'
  },
  {
    title: 'Insurance Contracting Coordination',
    desc: 'Strategic management of payer contracting documentation and submission timelines.',
    icon: FileBarChart,
    id: 'credentialing-6'
  },
  {
    title: 'Contract Rate Negotiation',
    desc: 'Data-driven negotiation tactics to secure and maintain the best possible reimbursement rates.',
    icon: Handshake,
    id: 'credentialing-7'
  },
  {
    title: 'NPI Registration',
    desc: 'Guidance and execution of individual and organizational NPI enumeration and updates.',
    icon: ClipboardList,
    id: 'credentialing-8'
  }
];
      ...
      <main>
              ...
              <div className="flex flex-col justify-start lg:sticky lg:top-24 sm:py-12 lg:py-0 order-1 lg:order-1">
                <div>
                  ...
                  <h1 className="text-[clamp(1.6rem,3.6vw,2.6rem)] font-display font-black text-slate-950 leading-[1.1] mb-6 md:mb-10">
                     ...
                     <span className="relative inline-block pl-0 pb-2.5">
        ...
        <section className="pt-6 md:pt-8 pb-6 md:pb-10 bg-white flex flex-col items-center">
           <div className="max-w-7xl mx-auto px-6 w-full">
              <div className="text-center mb-2 md:mb-6 text-slate-900">
               ...
               <div className="w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-10 px-4 md:px-0">
              ...
              >
                <div className="bg-gradient-to-br from-[#0f3d3a] to-[#0B6B57] rounded-[3rem] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="relative z-10 text-center md:text-left">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-accent/20 border border-brand-accent/30 text-brand-accent text-[9px] font-black uppercase tracking-[0.4em] mb-3 animate-pulse">
                      <Sparkles size={11} />
                      Free · No Obligation
                    </div>
                    ...
                    <p className="text-white/50 text-sm font-bold max-w-sm">
                      Pick a time that works — meet our credentialing specialists in minutes.
                    </p>
                  </div>
        ...
        <section id="specialties-lp" className="py-6 md:py-12 bg-white relative overflow-hidden">
           ...
           <div className="max-w-7xl mx-auto px-6">
              <div className="text-center mb-4 md:mb-12">
               ...
               {/* SPECIALTIES GRID: FULL RESPONSIVE LONG-SCROLL */}
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 overflow-visible">
                  {[
                     ...
                     { 
                        ...
                        desc: 'Seamless architectural bridge between Credentialing and high-velocity revenue cycle performance.',
                        icon: Activity,
                        tag: 'PERFORMANCE'
                     }
                  ].map((w, i) => (
        ...
        <section className="py-6 md:py-12 bg-white flex flex-col items-center">
           <div className="max-w-7xl mx-auto px-6 w-full">
...
export default ProviderCredentialingLP;
