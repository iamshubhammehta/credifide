        ...
        <div className="grid lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="saas-card p-5 sm:p-8 lg:p-14 bg-white border-brand-light shadow-2xl shadow-brand-deep/10 h-full flex flex-col"
            >
              <form className="space-y-5 sm:space-y-7 flex-grow">
                <div className="grid grid-cols-2 gap-4 sm:gap-7">
                  <div className="space-y-2">
                    <label htmlFor="first_name" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">First Name</label>
                    <input 
                      id="first_name"
                      type="text" 
                      placeholder="John"
                      className="w-full px-4 sm:px-6 py-3.5 sm:py-4 rounded-xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-brand-deep/5 focus:border-brand-deep transition-all font-medium bg-slate-50/30 text-sm"
                    />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="last_name" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">Last Name</label>
                    <input 
                      id="last_name"
                      type="text" 
                      placeholder="Doe"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-7">
                  <div className="space-y-2">
                    <label htmlFor="phone" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">Phone</label>
                    <input 
                      id="phone"
                      type="tel" 
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">Email</label>
                    <input 
                      id="email"
                      type="email" 
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-7">
                  <div className="space-y-2">
                    <label htmlFor="specialty" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">Specialty</label>
                    <input 
                      id="specialty"
                      type="text" 
                  ...
                  <div className="space-y-2">
                    <label htmlFor="practice_name" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">Practice Name</label>
                    <input 
                      id="practice_name"
                      type="text" 
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-7">
                  <div className="space-y-2">
                    <label htmlFor="providers" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">Providers</label>
                    <input 
                      id="providers"
                      type="number" 
                      placeholder="1-10"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="state" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">State</label>
                    <input 
                      id="state"
                      type="text" 
                      placeholder="e.g. DE"
                ...
                <div className="space-y-2 flex-grow">
                  <label htmlFor="message" className="text-[11px] sm:text-sm font-bold text-slate-700 ml-1">Message</label>
                  <textarea 
                    id="message"
                    rows={3}
                    placeholder="Briefly describe your goals..."
                    className="w-full px-4 sm:px-6 py-3.5 sm:py-4 rounded-xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-brand-deep/5 focus:border-brand-deep transition-all font-medium resize-none bg-slate-50/30 text-sm"
                  ></textarea>
                </div>

                {/* Disclaimer Box */}
                <div className="p-4 sm:p-6 bg-slate-50 border border-slate-200 rounded-2xl text-[10px] text-slate-500 leading-relaxed font-medium">
                  By providing your phone number, you agree to receive a text message from Credifide. Msg/Data rates may apply. To stop, reply 'STOP'.{' '}
                  <Link to="/privacy" className="text-brand-deep hover:underline font-bold">Privacy</Link> | <Link to="/terms" className="text-brand-deep hover:underline font-bold">Terms</Link>
                </div>

                {/* Acceptance Checkbox */}
                <label className="flex items-start p-1.5 gap-4 cursor-pointer group select-none">
                   <div className="mt-1 flex-none w-5 h-5 max-h-5 max-w-5 relative flex items-center justify-center">
                      <input 
                         type="checkbox" 
                         required
                         className="peer absolute inset-0 cursor-pointer appearance-none rounded-md border-2 border-slate-200 bg-white checked:bg-brand-deep checked:border-brand-deep transition-all duration-200" 
                      />
                      <IconRenderer 
                         icon={ASSETS.ui.check} 
                         size={12} 
                ...
                <button className="w-full py-4 sm:py-6 bg-brand-deep text-white rounded-2xl font-bold text-lg sm:text-xl hover:bg-brand-600 transition-all shadow-xl shadow-brand-deep/20 flex items-center justify-center gap-2 group mt-2">
                  Submit
