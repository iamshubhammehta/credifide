...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative flex flex-col justify-center overflow-hidden bg-transparent pt-4 pb-0 lg:pt-6 lg:pb-0">
      {/* Grid */}
      <div
      ...
      {/* Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center pt-4 pb-2 sm:pt-6 sm:pb-4 lg:pt-8 lg:pb-4">
        <motion.div
        ...
        <motion.h1
          ...
          className="text-[2.2rem] sm:text-5xl md:text-7xl lg:text-8xl font-display font-bold text-slate-900 leading-[1.05] tracking-tight mb-6 sm:mb-8"
        >
          We Build the{' '}
        ...
        <motion.p
          ...
          className="text-base sm:text-xl lg:text-2xl text-slate-500 max-w-3xl mx-auto leading-relaxed mb-10 sm:mb-14 px-2"
        >
    ...
    <section className="py-12 lg:py-16 bg-transparent relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6" ref={ref}>
        ...
        <div className="flex justify-center mb-12 px-4">
          <div className="relative flex bg-slate-100 rounded-2xl p-1.5 w-full max-w-[340px] sm:max-w-[400px]">
            <motion.div
          ...
          >
            <div className="space-y-6">
              ...
              <motion.div
                ...
                className={`p-5 rounded-2xl ${active === 'old' ? 'bg-white border border-red-200 shadow-sm' : 'bg-white/10 border border-white/20'}`}
              >
                <p className={`text-xs font-bold tracking-widest mb-2 ${active === 'old' ? 'text-red-600' : 'text-brand-light'}`}>CYCLE TIME</p>
                <p className={`font-bold text-3xl ${active === 'old' ? 'text-red-400' : 'text-white'}`}>
                  {active === 'old' ? '120' : '35'}
                </p>
                <p className={`text-sm mt-1 ${active === 'old' ? 'text-red-400/60' : 'text-brand-light/60'}`}>days average</p>
              </motion.div>
              ...
              <motion.div
                ...
                className={`grid grid-cols-2 gap-3 p-4 rounded-2xl ${active === 'old' ? 'bg-white/50 border border-red-200' : 'bg-white/5 border border-white/10'}`}
              >
                <div>
                  <p className={`text-xs font-bold ${active === 'old' ? 'text-red-600' : 'text-brand-light'}`}>{active === 'old' ? '12+' : '1'}</p>
                  <p className={`text-xs mt-1 ${active === 'old' ? 'text-red-400/70' : 'text-brand-light/70'}`}>Portals</p>
                </div>
                <div>
                  <p className={`text-xs font-bold ${active === 'old' ? 'text-red-600' : 'text-brand-light'}`}>{active === 'old' ? 'Manual' : 'Auto'}</p>
                  <p className={`text-xs mt-1 ${active === 'old' ? 'text-red-400/70' : 'text-brand-light/70'}`}>Entry</p>
                </div>
                <div>
                  <p className={`text-xs font-bold ${active === 'old' ? 'text-red-600' : 'text-brand-light'}`}>{active === 'old' ? 'Fax' : 'Digital'}</p>
                  <p className={`text-xs mt-1 ${active === 'old' ? 'text-red-400/70' : 'text-brand-light/70'}`}>Submit</p>
                </div>
                <div>
                  <p className={`text-xs font-bold ${active === 'old' ? 'text-red-600' : 'text-brand-light'}`}>{active === 'old' ? 'Reactive' : 'Proactive'}</p>
                  <p className={`text-xs mt-1 ${active === 'old' ? 'text-red-400/70' : 'text-brand-light/70'}`}>Issues</p>
                </div>
              </motion.div>
            </div>
...
const VisualBlock: React.FC = () => {
  ...
  return (
    <section className="py-12 lg:py-16 bg-brand-light/30 overflow-hidden relative">
